    ...
    return (
        <Paper className={classes.tableContainer}>
            <Table className={classes.fullWidth} size="small" aria-label="a dense table">
                ...
                <TableRow>
                    <TableCell className={classes.firstHeader} align="center" style={{width: '1%'}}>#</TableCell>
                    <TableCell className={classes.commonHeader} align="left">Title</TableCell>
                    <TableCell className={classes.commonHeader} align="left">Description</TableCell>
                    <TableCell className={classes.lastHeader} align="left">Video</TableCell>
                </TableRow>
                </TableHead>
                <TableBody>
                {records.map((row) => (
                ...
                <TableRow>
                    <TableCell className={classes.bottomCell} align = "center" colSpan={4}>Help Description Table</TableCell>
                </TableRow>
                </TableBody>
            </Table>
        </Paper>
