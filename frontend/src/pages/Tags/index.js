      ...
      >
        <Table size="small">
          <TableHead className={classes.tableHeader}>
            <TableRow>
              <TableCell className={classes.firstHeader} align="center">{i18n.t("tags.table.name")}</TableCell>
          ...
          <TableBody>
            ...
            <TableRow>
              <TableCell className={classes.bottomCell} colSpan = "3" align = "center">Tags table</TableCell>
            </TableRow>
          </TableBody>
        </Table>
      </Paper>
